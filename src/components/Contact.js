            ...
            <div className='container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap'>
                <div className='lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative'>
                    <iframe
                      ...
                      src="https://www.google.com/maps/embed/v1/place?q=Hendersonville,+TN&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                    />
                    <div className='bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md'>
                        ...
                        <div className='lg:w-1/2 px-6 mt-4 lg:mt-0'>
                            ...
                            <a className='text-indigo-400 leading-relaxed'>
                                jamesaaronlindsey182@gmail.com
                            </a>
                            <h2 className='title-font font-semibold text-white tracking-widest text-xs mt-4'>
                                Phone
                            </h2>
                            <p className='leading-relaxed'>615-389-8708</p>
                        </div>
                    </div>
                </div>
                <form
                  ...
                  className='lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0'>
                    ...
                    <p className='leading-relaxed mb-5'>
                        Viewing this from an application I've sent in? Looking for a developer
                        to take on a freelance project for you or your company? Send me a message
